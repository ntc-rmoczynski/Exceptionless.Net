...
namespace Exceptionless {
    public class EventBuilder : IEventBuilder {
        ...
        public IEventBuilder SetSource(string source) {
        ...
        public IEventBuilder SetReferenceId(string referenceId) {
        ...
        public IEventBuilder SetEventReference(string name, string id) {
        ...
        public IEventBuilder SetMessage(string message) {
        ...
        public IEventBuilder SetException(Exception ex) {
        ...
        public IEventBuilder SetGeo(string coordinates) {
        ...
        public IEventBuilder SetGeo(double latitude, double longitude) {
        ...
        public IEventBuilder SetValue(decimal value) {
            Target.Value = value;
            return this;
        }
        ...
        public IEventBuilder AddTags(params string[] tags) {
            Target.AddTags(tags);
            return this;
        }
        ...
        public IEventBuilder SetProperty(string name, object value, int? maxDepth = null, ICollection<string> excludedPropertyNames = null, bool ignoreSerializationErrors = false) {
            if (value != null)
        ...
        /// <param name="excludedPropertyNames">Any property names that should be excluded.</param>
        /// <param name="ignoreSerializationErrors">Specifies if properties that throw serialization errors should be ignored.</param>
        public IEventBuilder AddObject(object data, string name = null, int? maxDepth = null, ICollection<string> excludedPropertyNames = null, bool ignoreSerializationErrors = false) {
            if (data != null)
        ...
        /// </summary>
        public IEventBuilder MarkAsCritical() {
