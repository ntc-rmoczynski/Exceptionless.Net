...
namespace Exceptionless {
    public static class EventExtensions {
        public static Error GetError(this IEvent ev, IJsonSerializer serializer = null) {
            return ev.GetDataValue<Error>(Event.KnownDataKeys.Error, serializer);
        }

        public static SimpleError GetSimpleError(this IEvent ev, IJsonSerializer serializer = null) {
            return ev.GetDataValue<SimpleError>(Event.KnownDataKeys.SimpleError, serializer);
        }

        public static RequestInfo GetRequestInfo(this IEvent ev, IJsonSerializer serializer = null) {
            return ev.GetDataValue<RequestInfo>(Event.KnownDataKeys.RequestInfo, serializer);
        }

        public static EnvironmentInfo GetEnvironmentInfo(this IEvent ev, IJsonSerializer serializer = null) {
        ...
        /// </summary>
        public static bool IsCritical(this IEvent ev) {
        ...
        /// </summary>
        public static void MarkAsCritical(this IEvent ev) {
            if (ev.Tags == null)
                ev.Tags = new TagSet();
        ...
        /// </summary>
        public static bool IsNotFound(this IEvent ev) {
        ...
        /// </summary>
        public static bool IsError(this IEvent ev) {
        ...
        /// </summary>
        public static bool IsLog(this IEvent ev) {
        ...
        /// </summary>
        public static bool IsFeatureUsage(this IEvent ev) {
        ...
        /// </summary>
        public static bool IsSessionStart(this IEvent ev) {
        ...
        /// </summary>
        public static void AddRequestInfo(this IEvent ev, RequestInfo request) {
            if (request == null)
                return;
        ...
        public static void SetVersion(this IEvent ev, string version) {
        ...
        /// </summary>
        public static UserInfo GetUserIdentity(this IEvent ev, IJsonSerializer serializer = null) {
        ...
        public static void SetUserIdentity(this IEvent ev, string identity) {
        ...
        public static void SetUserIdentity(this IEvent ev, string identity, string name) {
        ...
        public static void SetUserIdentity(this IEvent ev, UserInfo userInfo) {
            if (userInfo == null)
                return;
        ...
        /// </summary>
        public static UserDescription GetUserDescription(this IEvent ev, IJsonSerializer serializer = null) {
        ...
        public static void SetUserDescription(this IEvent ev, string emailAddress, string description) {
        ...
        public static void SetUserDescription(this IEvent ev, UserDescription description) {
        ...
        public static void SetGeo(this IEvent ev, string coordinates) {
        ...
        public static void SetGeo(this IEvent ev, double latitude, double longitude) {
        ...
        public static void AddTags(this IEvent ev, params string[] tags) {
        ...
        public static void SetReferenceId(this IEvent ev, string referenceId) {
        ...
        /// <returns></returns>
        public static string GetEventReference(this IEvent ev, string name) {
        ...
        public static void SetEventReference(this IEvent ev, string name, string id) {
        ...
        public static void SetManualStackingInfo(this IEvent ev, IDictionary<string, string> signatureData) {
        ...
        /// <param name="signatureData">Key value pair that determines how the event is stacked.</param>
        public static void SetManualStackingInfo(this IEvent ev, string title, IDictionary<string, string> signatureData) {
        ...
        public static void SetManualStackingKey(this IEvent ev, string manualStackingKey) {
        ...
        /// <param name="title">The stack title.</param>
        /// <param name="manualStackingKey">The manual stacking key.</param>
        public static void SetManualStackingKey(this IEvent ev, string title, string manualStackingKey) {
        ...
        public static T GetDataValue<T>(this IEvent ev, string key, IJsonSerializer serializer = null) {
